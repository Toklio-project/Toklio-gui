...
public:
    enum Direction {
        Direction_In  =  Toklio::TransactionInfo::Direction_In,
        Direction_Out =  Toklio::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Toklio::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Toklio::TransactionInfo * m_pimpl;

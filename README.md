...
- Github: [https://github.com/Toklio-project/Toklio-gui](https://github.com/Toklio-project/Toklio-gui)
...
The Toklio GUI on Windows is 64 bits only.
...
3. Install MSYS2 packages for Toklio dependencies; the needed 64-bit packages have `x86_64` in their names
    ...
    You find more details about those dependencies in the [Toklio documentation](https://github.com/Toklio-project/Toklio). Note that that there is no more need to compile Boost from source; like everything else, you can install it now with a MSYS2 package.

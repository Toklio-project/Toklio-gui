...
<context>
    ...
    <message>
        ...
        <translation>&lt;style type=&apos;text/css&apos;&gt;a {text-decoration: none; color: #2f89f2; font-size: 14px;}&lt;/style&gt;                        Ищите настройки уровня конфиденциальности и адресную книгу? Кликните на вкладку &lt;a href=&apos;#&apos;&gt;Отправить&lt;/a&gt;</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Майнинг на вашем компьютере помогает обезопасить сеть Toklio. Чем больше людей майнит, тем сложнее атаковать сеть, и каждый майнер вносит свой вклад в этот процесс. &lt;br&gt; &lt;br&gt;Майнинг также дает вам небольшой шанс добыть несколько монет Toklio. Ваш компьютер будет искать хеши для решения блоков. Если вы найдете блок, то получите вознаграждение. Удачи!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>С достаточным количеством Toklio</translation>
    </message>
    <message>
        <location filename="../pages/Receive.qml" line="139"/>
        <source>With not enough Toklio</source>
        <translation>С недостаточным количеством Toklio</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Во избежание аннулирования защиты, обеспечиваемой кольцевыми подписями Toklio, выход не должен проводиться с разными кольцами на разных блокчейнах. Хотя это, как правило, не вызывает беспокойства, он может стать одним, если какой-то клон Toklio, использующий ключ повторно, позволяет вам тратить существующие выходы. В этом случае вам необходимо обеспечить, чтобы эти существующие выходы использовали одно и то же кольцо для обеих цепей.&lt;br&gt;Это может быть сделано автоматически Toklio или любым программным обеспечением с возможностью повторного использования ключей, которое не будет пытатся лишить вас конфиденциальности.&lt;br&gt;Если вы используете клон Toklio с повторным использованием ключа, и этот клон не включает эту защиту, вы все равно можете гарантировать, что ваши транзакции будут защищены, сделав их сначала на клоне, затем вручную добавить кольцо на этой странице, что позволит вам конфиденциально перевести ваши Toklio.&lt;br&gt;Если вы не используете клон Toklio с повторным использованием ключей без этих функций безопасности, то вам не нужно ничего делать, поскольку все автоматизировано.&lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Toklio отправлены успешно</translation>
    </message>
    <message>
...
Пожалуйста произведите обновление программного обеспечения или подключитесь к другому демону</translation>
    ...
    <message>
        ...
        <translation>&lt;style type=&apos;text/css&apos;&gt;a {text-decoration: none; color: #2f89f2; font-size: 14px;}&lt;/style&gt;&lt;font size=&apos;2&apos;&gt; (&lt;/font&gt;&lt;a href=&apos;#&apos;&gt;Запустить демона&lt;/a&gt;&lt;font size=&apos;2&apos;&gt;)&lt;/font&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Мы почти готовы к работе. Необходимо еще сделать некоторые настройки для Toklio</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Майнинг защищает сеть Toklio, а также платит небольшую награду за проделанную работу. Эта опция позволяет Toklio майнить, когда ваш компьютер включен и простаивает. Когда вы продолжите работать, он прекратит майнинг.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Для того, чтобы обмениваться данными з сетью Toklio ваш кошелек должен быть подключен к ноде Toklio. Для лучшей конфиденциальности рекомендуется запустить собственную ноду.                         &lt;br&gt;&lt;br&gt;                         Если у вас нет возможности запустить собственную ноду, есть возможность подключится к удаленной ноде.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Разработка Toklio полностью поддерживается пожертвованиями</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ПОЛЬЗУЙТЕСЬ TOKLIO</translation>
    </message>
    <message>
...
Индекс адреса траты: </translation>
    ...
    <message>
        ...
        <translation>Toklio отправлено успешно: %1 транзакция(й) </translation>
    </message>
    <message>

...
<context>
    ...
    <message>
        ...
        <translation>第三者がリング内に既知の使用済みインプットを見つけられないことは、Toklioトランザクションのどのインプットが使用されたのかを隠すために必要です。もし見つけられるとリング署名による保護は弱まります。もし1つのインプットを除いてすべてが使用済みだと知られている場合、実際に使用されたインプットは明らかとなり、Toklioが使っている3つの主要なプライバシー保護レイヤーのうちの1つであるリング署名の効果が失われてしまいます。&lt;br&gt;トランザクションでそれらのインプットを避けるため、既知の使用済みインプットのリストを用いてそれらを新規のトランザクションで使用しないようにできます。このようなリストはToklioプロジェクトによって保守されtokl.ioのウェブサイトで公開されており、ここではこのリストをインポートすることができます。&lt;br&gt;あるいはtoklio-blockchain-blackballというツールを使い、Toklioのブロックチェーン(およびキーを再利用するToklioクローンのブロックチェン)を自分でスキャンして既知の使用済みアウトプットのリストを生成できます。&lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>取引には少額の手数料がかかります。このオプションはその手数料に加えて、手数料の何パーセントかをToklioの開発チームへの寄付として支払うことを許可します。例えば自動寄付の割合が50%で、取引の手数料が0.005 TOKLであった場合、0.0025 TOKLが開発チームへの寄付として取引に上乗せされます。</translation>
    </message>
    <message>
...
金額: </translation>
    ...
    <message>
        ...
        <translation>新しいバージョンのtoklio-wallet-guiを入手できます: %1&lt;br&gt;%2</translation>
    </message>
    <message>

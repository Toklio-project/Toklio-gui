...
<context>
    ...
    <message>
        ...
        <translation>Toklioを送ったり受け取ったりするのが簡単になり、アドレスを手で打ち間違えるのを避けられます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>警告: キーの再利用に関する対策が組み込まれていない限り、Toklioのキーを別のフォークで使い回さないでください。あなたのプライバシーが損なわれます。</translation>
    </message>
    <message>
        ...
        <translation>警告: シードをクリップボードにコピーすると、シードを記録しToklioを盗む悪意あるソフトウェアに晒される可能性があります。シードは手で書き留めてください。</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Toklio. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>自分のコンピュータでマイニングをすることでToklioネットワークをより強固にできます。多くの人がマイニングをすればするほど、攻撃はより難しくなります。

マイニングをするとToklioが手に入ることがあります。コンピュータはブロックの解となるハッシュ値を生成し、もしブロックを見つけたら報酬が手に入ります。グッドラック！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>組み込まれているToklioのバージョン: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>サードパーティーのサーバを使ってToklioネットワークに接続します。セキュリティは低くなりますがより簡単です。</translation>
    </message>
    <message>
        ...
        <translation>リモートノードを見つけるには、お好きな検索エンジンで&apos;Toklio remote node&apos;と検索してください。ノードが信頼できるサードパーティーによって運営されていることを確認してください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>第三者がリング内に既知の使用済みインプットを見つけられないことは、Toklioトランザクションのどのインプットが使用されたのかを隠すために必要です。もし見つけられるとリング署名による保護は弱まります。もし1つのインプットを除いてすべてが使用済みだと知られている場合、実際に使用されたインプットは明らかとなり、Toklioが使っている3つの主要なプライバシー保護レイヤーのうちの1つであるリング署名の効果が失われてしまいます。&lt;br&gt;トランザクションでそれらのインプットを避けるため、既知の使用済みインプットのリストを用いてそれらを新規のトランザクションで使用しないようにできます。このようなリストはToklioプロジェクトによって保守されtokl.ioのウェブサイトで公開されており、ここではこのリストをインポートすることができます。&lt;br&gt;あるいはtoklio-blockchain-mark-spent-outputsというツールを使い、Toklioのブロックチェーン(およびキーを再利用するToklioクローンのブロックチェン)を自分でスキャンして既知の使用済みアウトプットのリストを生成できます。&lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Toklioアドレス (例: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ToklioネットワークとやりとりするにはウォレットをToklioノードに接続する必要があります。プライバシーのためにはあなた自身がノードを走らせることを推奨します。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Toklioをすぐに使いたい場合ブートストラップノードを指定できます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>もしToklioを使うのが初めてならこのオプションを選んでください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ハードウェアウォレットを接続して新しいToklioウォレットを作成</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Toklio GUIの言語を変更</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>(&lt;i&gt;ブートストラップ&lt;/i&gt;という名前が示すように)リモートノードを一時的に使用することはToklioをすぐに使うのに便利です。ただしリモートノードを使う場合(ブートストラップ設定時を含む)、ノードはあなたのIPアドレスや&quot;復元を開始するブロック高&quot;とそれに付随するブロック要求データを追跡でき、あなたが送る取引についてより知るために正確でない情報を送ってくる可能性があります。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このモードは少額のToklioを扱う場合に適しています。取引を作成したり管理したりする基本的な機能にアクセスできます。Toklioネットワークに自動的に接続するためToklioをすぐに使い始めることができます。</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>ToklioネットワークとやりとりするためウォレットはToklioノードに接続する必要があります。プライバシーのため自分自身でノードを走らせることを推奨します。
...
金額: </translation>
    ...
    <message>
        ...
        <translation>このアドレスは%1TOKLを受け取りましたが、取引はまだ承認されていません。</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1057"/>
        <source>This address received %1 toklio, with %2 confirmation(s).</source>
        <translation>このアドレスは%1TOKLを受け取り、その取引は%2回承認されました。</translation>
    </message>
    <message>
...
手数料: </translation>
    ...
    <message>
        ...
        <translation>新しいバージョンの Toklio v.%1 が利用可能です。&lt;br&gt;&lt;br&gt;ダウンロード:&lt;br&gt;%2&lt;br&gt;&lt;br&gt;SHA256ハッシュ:&lt;br&gt;%3</translation>
    </message>
    <message>
        <location filename="../main.qml" line="2161"/>
        <source>New version of Toklio is available. Check out tokl.io</source>
        <translation>新しいバージョンのToklioが利用可能です。tokl.ioをチェックしてください。</translation>
    </message>
    <message>

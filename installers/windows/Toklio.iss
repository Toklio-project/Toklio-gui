; Toklio Hydrogen GUI Wallet Installer for Windows
...
; As of version 0.12.0.0, the Toklio .exe files do not carry version info anyway in their .exe headers.
...
Root: HKCU; Subkey: "Software\toklio-project\toklio-core"; ValueType: string; ValueName: "daemonFlags"; ValueData: {code:DaemonFlags};

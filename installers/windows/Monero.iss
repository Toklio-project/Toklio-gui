...
begin
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\monero-project\toklio-core', 'blockchainDataDir', blockChainDir);
...
Name: "{group}\Utilities\Monero Daemon"; Filename: "{app}\tokliod.exe"; Parameters: {code:DaemonFlags}
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\toklio-wallet-cli.exe"; WorkingDir: "{userdocs}\Monero\wallets"
...
Root: HKCU; Subkey: "Software\monero-project\toklio-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\monero-project\toklio-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};

...
# 3 header files required by toklio are missing from the IOS SDK. I copied them from iphoneSimulator SDK
...
rm -r Toklio/build > /dev/null
mkdir -p Toklio/build/release
pushd Toklio/build/release
